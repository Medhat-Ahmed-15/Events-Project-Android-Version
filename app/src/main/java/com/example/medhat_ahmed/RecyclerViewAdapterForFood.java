...
public class RecyclerViewAdapterForFood extends RecyclerView.Adapter<RecyclerViewAdapterForFood.MyViewHolder> implements TimePickerDialog.OnTimeSetListener  {
    ...
    public RecyclerViewAdapterForFood(Context mContext, List<Food> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       ...
       vHolder.event_checkbox_food.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
        ...
        vHolder.favorite_button_food.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {

                if(clicked==1) {

                    vHolder.favorite_button_food.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.ic_baseline_favorite));
                    ...
                    vHolder.favorite_button_food.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.ic_baseline_favorite_unclicked));
                    clicked=1;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.event_name_food.setText(mData.get(position).getEventName());



        holder.food_image.setImageResource(mData.get(position).getImage());
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            favorite_button_food = (Button) itemView.findViewById(R.id.favorite_button);
