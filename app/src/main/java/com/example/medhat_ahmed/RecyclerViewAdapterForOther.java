...
public class RecyclerViewAdapterForOther extends RecyclerView.Adapter<RecyclerViewAdapterForOther.MyViewHolder>implements TimePickerDialog.OnTimeSetListener {
    ...
    public RecyclerViewAdapterForOther(Context mContext, List<Other> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v;
        v= LayoutInflater.from(mContext).inflate(R.layout.item_other,parent,false);
       ...
       vHolder.event_checkbox_other.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
        {
            @Override
        ...
        vHolder.favorite_button_other.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {

                if(clicked==1) {

                    vHolder.favorite_button_other.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.ic_baseline_favorite));
                    ...
                    vHolder.favorite_button_other.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.ic_baseline_favorite_unclicked));
                    clicked=1;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.event_name_other.setText(mData.get(position).getEventName());



        holder.other_image.setImageResource(mData.get(position).getImage());
    ...
    public void filterList(ArrayList<Other> filteredList) {
        mData = filteredList;
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        TextView event_name_other;
        ImageView other_image;
        CheckBox event_checkbox_other;
        ConstraintLayout Layout;
        Button favorite_button_other;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            event_name_other = (TextView) itemView.findViewById(R.id.event_name);
            other_image = (ImageView) itemView.findViewById(R.id.image);
            event_checkbox_other = (CheckBox) itemView.findViewById(R.id.event_checkbox);
            favorite_button_other = (Button) itemView.findViewById(R.id.favorite_button);
