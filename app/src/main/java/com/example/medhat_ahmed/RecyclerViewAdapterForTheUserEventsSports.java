...
public class RecyclerViewAdapterForTheUserEventsSports extends RecyclerView.Adapter<RecyclerViewAdapterForTheUserEventsSports.MyViewHolder>   {

    static  Context theUserEventsContext;
    List<Sports> theUserEventsData;

    Dialog dialog;

    public RecyclerViewAdapterForTheUserEventsSports(Context theUserEventsContext, List<Sports> theUserEventsData) {
