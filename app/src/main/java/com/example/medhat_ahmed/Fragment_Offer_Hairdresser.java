...
public class Fragment_Offer_Hairdresser extends Fragment {
    ...
    public Fragment_Offer_Hairdresser() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v= inflater.inflate(R.layout.fragment_offer_hairdresser,container,false);


        myRecyclerview=(RecyclerView)v.findViewById(R.id.recyclerview_offer_hairdresser);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds:snapshot.getChildren()){
                    ...
                    if(obj.getType().equals("hairdresser"))
                    {
                        list.add(obj);
                    }
