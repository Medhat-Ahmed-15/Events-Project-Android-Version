...
public class RecyclerViewAdapterForTheUserEventsOther extends RecyclerView.Adapter<RecyclerViewAdapterForTheUserEventsOther.MyViewHolder>   {

    static  Context theUserEventsContext;
    List<Other> theUserEventsData;

    Dialog dialog;

    public RecyclerViewAdapterForTheUserEventsOther(Context theUserEventsContext, List<Other> theUserEventsData) {
