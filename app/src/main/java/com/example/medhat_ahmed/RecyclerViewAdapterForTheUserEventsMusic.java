...
public class RecyclerViewAdapterForTheUserEventsMusic extends RecyclerView.Adapter<RecyclerViewAdapterForTheUserEventsMusic.MyViewHolder>   {

    static  Context theUserEventsContext;
    List<Music> theUserEventsData;

    Dialog dialog;

    public RecyclerViewAdapterForTheUserEventsMusic(Context theUserEventsContext, List<Music> theUserEventsData) {
