...
public class Food {
    ...
    public Food(String eventName, String eventLocation, String eventdate, String eventTime, String eventDescription, String eventNumberOfGuests, String userID, int image) {
