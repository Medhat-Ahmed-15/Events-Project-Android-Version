...
public class RecyclerViewAdapterForSports extends RecyclerView.Adapter<RecyclerViewAdapterForSports.MyViewHolder>implements TimePickerDialog.OnTimeSetListener {
    ...
    public RecyclerViewAdapterForSports(Context mContext, List<Sports> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v;
        v= LayoutInflater.from(mContext).inflate(R.layout.item_sports,parent,false);

        final MyViewHolder vHolder=new MyViewHolder(v);

        //DIALOG INI
        dialog=new Dialog(mContext);
        dialog.setContentView(R.layout.dialog_sports);
       ...
       vHolder.event_checkbox_sports.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
        {
            @Override
        ...
        vHolder.favorite_button_sports.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {

                if(clicked==1) {

                    vHolder.favorite_button_sports.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.ic_baseline_favorite));
                    ...
                    vHolder.favorite_button_sports.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.ic_baseline_favorite_unclicked));
                    clicked=1;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.event_name_sports.setText(mData.get(position).getEventName());


        holder.sports_image.setImageResource(mData.get(position).getImage());
    ...
    public void filterList(ArrayList<Sports> filteredList) {
        mData = filteredList;
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        TextView event_name_sports;
        ImageView sports_image;
        CheckBox event_checkbox_sports;
        ConstraintLayout Layout;
        Button favorite_button_sports;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            event_name_sports = (TextView) itemView.findViewById(R.id.event_name);
            sports_image = (ImageView) itemView.findViewById(R.id.image);
            event_checkbox_sports = (CheckBox) itemView.findViewById(R.id.event_checkbox);
            favorite_button_sports = (Button) itemView.findViewById(R.id.favorite_button);
