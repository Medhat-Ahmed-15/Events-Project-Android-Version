...
public class Sports {
    ...
    public Sports(String eventName, String eventLocation, String eventdate, String eventTime, String eventDescription, String eventNumberOfGuests, String userID, int image) {
